...
- `49-plan-documentation-context.mdc` — when authoring a multi-phase Cursor/plan file for feature work, include the Documentation context table per the repo template.
