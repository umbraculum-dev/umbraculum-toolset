...
Cursor assistant plugin for the umbraculum-toolset **industrial-automation sister-repo** at `~/dkprojects/arduino-and-plc/openplc/brewery/tanks-pump-priority-and-low-high-levels-sensors-alarms/` (and any future project that adopts the same OpenPLC + Python + FastAPI + Modbus + hardware-doc pattern).
...
The 9 domain rules were inferred from a focused exploration of `~/dkprojects/arduino-and-plc/openplc/brewery/tanks-pump-priority-and-low-high-levels-sensors-alarms/` on 2026-05-18, primarily from:
...
- `~/dkprojects/rfapps/umbraculum-toolset/cursor-plugins/README.md` — multi-plugin overview + install + pairing rationale.
- `~/dkprojects/rfapps/umbraculum-toolset/cursor-plugins/docs/PLUGIN-ROADMAP.md` — future shared-meta plugin + private-vs-marketplace transition notes.
- `~/dkprojects/arduino-and-plc/openplc/brewery/tanks-pump-priority-and-low-high-levels-sensors-alarms/DEVELOPMENT.md` — the upstream convention document this plugin codifies for Cursor.
