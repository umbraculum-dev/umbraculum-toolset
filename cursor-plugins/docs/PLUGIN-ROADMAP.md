...
This repo hosts **four plugins** under `/path/to/umbraculum-toolset/cursor-plugins/`:
...
2. `ln -s /path/to/umbraculum-toolset/cursor-plugins/umbraculum-node-react-cursor-assistant ~/.cursor/plugins/local/umbraculum-node-react-cursor-assistant`
