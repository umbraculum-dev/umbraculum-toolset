...
- `~/dkprojects/rfapps/umbraculum-toolset/cursor-plugins/README.md` — multi-plugin overview + install + the why-pair-both rationale.
- `~/dkprojects/rfapps/umbraculum-toolset/cursor-plugins/umbraculum-node-react-cursor-assistant/` — the generic companion plugin.
- `~/dkprojects/rfapps/umbraculum-toolset/cursor-plugins/umbraculum-toolset-common/` — the language-agnostic meta-framework rules + the `generate-development-local` skill.
