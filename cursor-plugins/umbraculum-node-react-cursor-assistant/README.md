...
- `80-monorepo-lockfile-agent-gate.mdc` (`alwaysApply: true`; umbraculum-dev repo-side copy; agent-owned root lockfile regen + forbidden `services/api/package-lock.json`)
