...
- [`docs/rfcs/0003-validation-library-adoption.md`](../../../../../dkprojects/rfapps/umbraculum-dev/docs/rfcs/0003-validation-library-adoption.md) — Zod v4 commitment + Decisions A–G.
- [`docs/CONTRACTS-VALIDATION-STRATEGY.md`](../../../../../dkprojects/rfapps/umbraculum-dev/docs/CONTRACTS-VALIDATION-STRATEGY.md) v2.0 — strategy SoT.
- [`packages/contracts/src/auth/meResponse.ts`](../../../../../dkprojects/rfapps/umbraculum-dev/packages/contracts/src/auth/meResponse.ts) — worked example (PR 1 reference).
